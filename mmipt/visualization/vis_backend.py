...
class WandbVisBackend(BaseWandbVisBackend):
    ...
    def _extra_config(self, mode='online'):
        from mmengine.logging import MessageHub
        msg_hub = MessageHub.get_current_instance()
        self._init_kwargs['project'] = 'mmipt'
        self._init_kwargs['name'] = msg_hub._instance_name[:-16]
