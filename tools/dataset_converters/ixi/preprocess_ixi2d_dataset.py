...
def write_ann(file, prefix, paths):
    ...
    data_ann = dict()
    data_ann['metainfo'] = get_metainfo('ixi2d')
...
if __name__ == '__main__':
    ...
    # data_link = 'https://surfer.nmr.mgh.harvard.edu/ftp/data/ixi/ixi_processed_dataset.tar.gz'
    root = 'data/reg/IXI2d'
    ...
    for phase in splits.keys():
        ...
        write_ann(
            osp.join(root, 'annotations', f'{phase}_ixi2d_scan2scan.json'),
