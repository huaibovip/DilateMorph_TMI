...
def write_ann(file, prefix, paths):
    ...
    data_ann = dict()
    data_ann['metainfo'] = get_metainfo('oasis3d')
...
if __name__ == '__main__':
    ...
    # OASIS_L2R_2021_task03: https://learn2reg.grand-challenge.org/Learn2Reg2021/
    data_link = 'https://surfer.nmr.mgh.harvard.edu/ftp/data/neurite/data/neurite-oasis.v1.0.tar'
    root = 'data/reg/OASIS3d'
    ...
    for phase in splits.keys():
        ...
        write_ann(
            osp.join(root, 'annotations', f'{phase}_oasis3d_scan2scan.json'),
